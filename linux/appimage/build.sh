...
run "$python" -m plover_build_utils.download 'https://github.com/AppImage/AppImages/raw/master/functions.sh' '5f955608399465a7e17009704ef1aecbcfb1121f' "$cachedir/functions.sh"
