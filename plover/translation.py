...
def _find_translation(translations, dictionary, stroke, mapping):
    ...
    t = _find_translation_helper(translations, dictionary, stroke, theory.STENO_KEY_SUFFIXES)
    if t:
        return t
    return Translation([stroke], _lookup([stroke], dictionary, theory.STENO_KEY_SUFFIXES))
